...
public class CarteAbonnee implements Serializable {
    ...
    public CarteAbonnee(int no_abonne, String nom_abonne, String adresse_abonne,
                        LocalDate date_abonnement, LocalDate date_entree) {
    ...
    @Override
    public String toString() { return "Carte[" + no_abonne + "] " + nom_abonne; }
}
